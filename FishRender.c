...
void lips(double x, double y, double z, double r, unsigned int lipTexture) {
   ...
   glPushMatrix();
   //  Offset and scale
   //These have to be included or else translae is called in the wrong order due to the call in ball.
